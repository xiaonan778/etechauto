...
<head>
    ...
    <script src="${path }/scripts/platform/active/tenant_active_summary.js" ></script>
                    ...
                    <div class="panel panel-default">
		                <div class="panel-heading panel-title">
		                 ...
		                 <div class="panel-body clearfix" style="text-align: center">
		                    ...
		                    <span class="text-primary" style="margin-left: -120px;">活跃租户报表</span>
		                 </div>
		            </div>
		            <input type="hidden" id="position" value="summary" />
		            <div class="row" style="width: 100%;height: 620px;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="tenant_active_chart"></div>
		                    <div class="container-sum" id="tenant_active_subitem"></div>
		                </div>
		            </div>
