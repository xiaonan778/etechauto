...
<head>
    ...
    <script src="${path }/scripts/platform/new/tenant_summary.js" ></script>
                    ...
                    <div class="panel panel-default">
		                <div class="panel-heading panel-title">
		                 ...
		                 <div class="panel-body clearfix" style="text-align: center">
		                    ...
		                    <span class="text-primary" style="margin-left: -120px;">租户报表</span>
		                 </div>
		            </div>
		            <input type="hidden" id="position" value="summary" />
		            <div class="row" style="width: 100%;height: 630px;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="tenant_trend_chart"></div>
		                    <div class="container-sum" id="tenant_trend_subitem"></div>
		                </div>
		            </div>
		            <br>
		            <div class="row" style="width: 100%;height: 650px;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="tenant_trade_chart"></div>
		                    <div class="container-sum" id="tenant_trade_subitem"></div>
		                </div>
		            </div>
		            <br>
		            <div class="row" style="width: 100%;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="tenant_prodtrade_chart"></div>
		                    <div class="container-sum" id="tenant_prodtrade_subitem"></div>
		                </div>
		            </div>
                    <div style="height: 40px;"></div>
                </div><!-- /.page-content -->
