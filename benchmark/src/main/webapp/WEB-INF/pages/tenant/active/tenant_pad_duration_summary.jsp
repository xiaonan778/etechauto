...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#pad_duration_chart").load(url,{tenant_fk:tenant_fk},function(){
                $("#pad_duration_report").prev().show();
            });
            
            var url1 = _path + "/report/pad/duration_sum_subitem";
            $("#pad_duration_subitem").load(url1,{tenant_fk:tenant_fk});
			            ...
			            <div class="panel-heading panel-title">
			             ...
			             <div class="panel-body clearfix" style="text-align: center">
			                <div style="float: left;">
			                 ...
			                 <span class="text-primary" style="margin-left: -120px;">${tenantName} -Pad使用时长报表</span>
			             </div>
			        </div>
