...
<head>
    ...
    <script src="${path }/scripts/tenant/new/pad_summary.js" ></script>
            ...
            <div class="main-content" id="mainContent">
                <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">${tenantName } - Pad激活数据报表</li>
                    </ul><!-- .breadcrumb -->
                </div>
                    ...
                    <div class="panel panel-default">
			            <div class="panel-heading panel-title">
			             ...
			             <div class="panel-body clearfix" style="text-align: center">
			                ...
			                <span class="text-primary" style="margin-left: -120px;">${tenantName } - Pad激活数据报表</span>
			             </div>
			        </div>
