...
<head>
    ...
    <script src="${path }/scripts/platform/new/product_summary.js" ></script>
        ...
        <div class="main-container-inner">  
            ...
            <div class="main-content" id="mainContent">
                ...
                <div class="page-content">
                    ...
                    <div class="panel panel-default">
		                <div class="panel-heading panel-title">
		                 ...
		                 <div class="panel-body clearfix" style="text-align: center">
		                    ...
		                    <span class="text-primary" style="margin-left: -120px;">理财产品报表</span>
		                 </div>
		            </div>
		            ...
		            <div class="row" style="width: 100%;height: 650px;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="product_trade_category_chart"></div>
		                    <div class="container-sum" id="product_trade_category_subitem"></div>
		                </div>
		            </div>
		            <br>
		            <div class="row" style="width: 100%;height: 650px;margin: 0 auto;border: 1px solid #ddd;">
		                <div class="col-xs-12" >
		                    <div id="product_catetenant_chart"></div>
		                    <div class="container-sum" id="product_catetenant_subitem"></div>
		                </div>
		            </div>
		            <br>
