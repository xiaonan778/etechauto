...
<head>
    ...
    <script src="${path }/scripts/tms/tenant_config_add.js" ></script>
			                    ...
			                    <div class="col-md-6">
			                          <div class="form-group">
			                            <div class="input-group">
			                                    <div class="input-group-addon" id="dbName">库名：</div>
			                                    <input value="${tenant.id}" type="hidden" id="tenantFk">        
			                                    <input class="form-control" type="text" id="name" name="name"  onkeyup="validateText(1);" placeholder="请输入数据库名">                               
			                            </div>
			                          </div>
			                    </div>
			                </div>                  
			            ...
			            <div class="row">
			                <div class="col-md-12">
			                    <div class="col-md-6">
			                        <div class="form-group">
			                            <div class="input-group">
			                                <div class="input-group-addon" id="dbAccount"> 帐号：</div>
			                                <input class="form-control"  type="text" id="account" name="account" onkeyup="validateText(2)" placeholder="请输入数据库账号">  
			                            </div>
			                        </div>
			                    </div>
			                    <div class="col-md-6">
			                          <div class="form-group">
			                            <div class="input-group">
			                                    ...
			                                    <input class="form-control" type="text" id="password" name="password"  placeholder="请输入数据库密码">      
			                            </div>
			                          </div>
			                    </div>
			                </div>                  
			                    ...
			                    <div class="col-md-12">
			                        <div class="form-group">
			                            <div class="input-group">
			                                ...
			                                <textarea class="form-control" rows="2" id="memo" name="memo" maxlength="200"></textarea>
			                            </div>
			                        </div>
			                    </div>
			                </div>
			                            ...
			                            <div class="input-group">
			                                <c:forEach items="${dictionaryList}" var="dictionary">
			                                  <div style="display: inline-block">
			                                     <input class="pbgl" type="checkbox" id="glmk-${dictionary.id}" data-ref="${dictionary.rule }" name="glmk" value="${dictionary.id}" >
			...
			<!--            <div class="col-md-12">
			            ...
			            <div class="row">
			             ...
			             <div class="text-center">
			                <button type="button" class="btn btn-primary" onclick="addConfig();">保存</button>
			            </div>
			              </form>
			            </div>             
			         </div>    
