                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="name" name="name" placeholder="请输入车型名称">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                               <div class="form-group">
                                                   <div class="input-group">
                                                       ...
                                                       <input class="form-control" type="text" id="sorter" name="sorter" placeholder="请输入排序">
                                                   </div>
                                               </div>
                                           </div>
                                    </div>
                                ...
                                <div class="row">
                                       <div class="col-md-12">
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   <div class="input-group">
                                                       <div class="input-group-addon">是否为第一层分类</div>
